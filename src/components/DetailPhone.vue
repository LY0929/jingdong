  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <div class="title">
        ...
        <p class="one">{{phone.title}}</p>
        <div class="img" @click="change(phone.id,phone.isCollected)"><i :class="[classA,classB]"></i><span>关注</span></div>
        <p class="in">部分仓库有新老包装替换，请知悉，感谢谅解！</p>
        <p class="price">￥<span>{{phone.price}}</span><i>降价提醒</i></p>
...
<script>
  import {getPhoneById,setCollect} from "../api/getData";
...
<style scoped>
  ...
  .container .phone-img{text-align:center;border-bottom:1px solid #ccc}
