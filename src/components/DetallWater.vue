  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <div class="title">
        ...
        <p class="one">{{water.title}}</p>
        <div class="img" @click="change(water.id,water.isCollected)"><i :class="[classA,classB]"></i><span>关注</span></div>
        <p class="in">部分仓库有新老包装替换，请知悉，感谢谅解！</p>
        <p class="price">￥<span>{{water.price}}</span><i>降价提醒</i></p>
      ...
      <div class="txt">
        ...
        <div class="div2">
          <p><span>满送</span>满19元即赠热销商品，赠完即止</p>
          <p class="p1"><span>加价购</span>满99元,即可在购物车换购热销商品</p>
        </div>
      </div>
    </div>
  </div>
...
<script>
  import {getWaterById,setCollect} from "../api/getData";
...
<style scoped>
  ...
  .container .water-img{text-align:center;border-bottom:1px solid #ccc}
  ...
  .container .txt{width:90%;margin:auto;padding: 10px 0;overflow: auto;}
