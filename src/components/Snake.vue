...
<style scoped>
  ...
  .content .head{width:100%;height: 50px;line-height:50px;}
  .content .head p{width:100%;color: red;font-weight: bold;font-size: 17px}
  .content .head p .one{float: left;font-size:24px;margin-left: 5px}
